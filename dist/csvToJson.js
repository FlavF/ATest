...
exports.convertToJson = (0, csvtojson_1.default)().fromFile(csvFilePath).then((datas) => {
    ...
    const arrayJson = (0, FunctionsForArray_1.reduceArray)(newJson);
    //? Write the datas on the json file
    (0, FunctionsJson_1.writeToJson)(jsonDatas, arrayJson);
});
